...
| [./media/image4.png](./media/image4.png)                                                                                                                                                                                                  > Hint: If you don’t know the meaning of a specific CSS property, you can always search it on [W3Schools](http://www.w3schools.com) 
    ...
    ```CSS
    body { font-family: tahoma; font-size: 11pt; line-height: 1.2em; margin: 0; padding: 12px; }
    h1{ 
    ...
    td,th { padding: 8px 12px; border-bottom: 1px solid Gray; 
    }
    th { background-color: \#EEEEEE; }
    caption { padding: 8px 12px; border: 1px solid Gray; border-bottom: none; background-color: \#E0E0E0; font-weight: bold; }
    
    tfoot { 
        background-color: \#EEEEEE; font-weight: bold;  
    }
    
    form { border: 1px solid Gray; border-radius: 5px; background-color: \#EEEEEE; padding: 16px;  float: right;  width: 30%;
    }
