# 3. Cascading Style Sheets - CSS <!-- omit in toc -->
...
- [Basic types of selectors](#basic-types-of-selectors)
  ...
  - [Inheritance and cascade](#inheritance-and-cascade)
  ...
  - [CSS layout model - boxes borders margins padding](#css-layout-model---boxes-borders-margins-padding)
...
-   **Cascading Style Sheets** (**CSS**) are a
    ...
    language used to describe the presentation of a document written in [HTML](https://developer.mozilla.org/en-US/docs/HTML) or [XML](https://developer.mozilla.org/en-US/docs/XML) (including XML dialects like [SVG](https://developer.mozilla.org/en-US/docs/SVG) or
...
-   While HTML structures the document and tells browsers what a certain element’s function is (it is a link to another page? Is it a heading?), CSS gives the browser instructions on how to display a certain element — styling, spacing, colouring, etc.
...
> Further reading: [CSS3 Basics](https://www.w3.org/wiki/CSS_basics)
...
> Naming convention for classes and ids: https://google.github.io/styleguide/htmlcssguide.html#ID_and_Class_Name_Delimiters
...
> Further reading: [Advanced CSS selectors](https://www.w3.org/community/webed/wiki/Advanced_CSS_selectors)
...
> Further reading: [Inheritance and Cascade](https://www.w3.org/community/webed/wiki/Inheritance_and_cascade)
...
## CSS layout model - boxes borders margins padding
...
-   The margin properties set the size of the white space outside the border.
    ...
    /* equivalent to p{ margin: 100px 150px 100px 80px; }*/
    ```

    > Further reading: [CSS Margin](http://www.w3schools.com/css/css_margin.asp)
...
> Further reading: [CSS Padding](http://www.w3schools.com/css/css_padding.asp)
...
> Further reading: [CSS layout model](https://www.w3.org/community/webed/wiki/The_CSS_layout_model_-_boxes_borders_margins_padding) and [CSS Box Model](http://www.w3schools.com/css/css_boxmodel.asp)
...
> Further reading: [W3C WebEd - CSS](http://www.w3.org/community/webed/wiki/Main_Page#CSS) : *9. Styling forms*, *10. Floats and clearing* 
...
> Further reading: [W3C WebEd - Floats and clearing](https://www.w3.org/community/webed/wiki/Floats_and_clearing)
...
> Further reading: [W3C WebEd - CSS](http://www.w3.org/community/webed/wiki/Main_Page#CSS) : *11. CSS static and relative positioning și 12. CSS absolute and fixed positioning*
...
1.  Add the CSS file `Agenda_HTML_CSS.css` with the following content.

    > Hint: If you don’t know the meaning of a specific CSS property, you can always search it on [W3Schools](http://www.w3schools.com) 

    ```CSS
    body { 
        font-family: tahoma; font-size: 11pt; line-height: 1.2em; margin: 0; padding: 12px; 
    }

    h1{ 
        background-color: Navy; color: White; margin: 0; padding: 16px; margin: -12px -12px 20px -12px; 
    }

    table { 
        border: 1px solid Gray; border-collapse: collapse; text-align: left; width: 60%; float: left; 
    }

    td,th { 
        padding: 8px 12px; border-bottom: 1px solid Gray; 
    }
    ...
    caption { 
        padding: 8px 12px; border: 1px solid Gray; border-bottom: none; background-color: #E0E0E0; font-weight: bold; 
    }
    ...
    form { 
        border: 1px solid Gray; border-radius: 5px; background-color: #EEEEEE; padding: 16px;  float: right;  width: 30%;
    }
    
    label { 
        display: block; float: left; clear: both; width: 35%; 
    }
    
    input { font-size: 11pt; display: block; float: right;  width: 60%; }
    
    input[type="button"] { font-weight: bold;  padding: 5px; }        ```                                                                                                                            |

4.  Reference the CSS file from the heading section of the `Agenda_HTML_CSS.html` file.

    ```HTML
    <head>
        <title>Agenda telefonică</title>
        <link rel="stylesheet" type="text/css" href="Agenda_HTML_CSS.css">
    </head>
    ```

1.  Open the page in a browser at your choice.

2.  Check whether the displayed page is similar to the one shown below.
